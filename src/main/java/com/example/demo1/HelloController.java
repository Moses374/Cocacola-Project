...
public class HelloController implements Initializable {
    ...
    private void loadData() {
        try {
            ...
            List<Drinks> drinksFromDB = drinkDAO.getAllDrinks();
            
            // If we have drinks from the database, use those
            if (!drinksFromDB.isEmpty()) {
                // Add sizes to the drinks (since the database doesn't store sizes)
                for (Drinks drink : drinksFromDB) {
                    // Set additional properties based on the drink name
                    enrichDrinkWithDetails(drink);
                }
                allDrinks.addAll(drinksFromDB);
            } else {
                // Fallback to hardcoded drinks if database is empty
                allDrinks.addAll(getHardcodedDrinks());
            }
            
            filteredDrinks.addAll(allDrinks);
            System.out.println("Loaded " + allDrinks.size() + " drinks");
            
            // Debug: Print all drink IDs
            for (Drinks drink : allDrinks) {
                System.out.println("Loaded drink: " + drink.getName() + " with ID: " + drink.getDrinkId());
            }
        } catch (Exception e) {
            System.err.println("Error loading drinks from database: " + e.getMessage());
            e.printStackTrace();
            // Fallback to hardcoded drinks
            allDrinks.addAll(getHardcodedDrinks());
            filteredDrinks.addAll(allDrinks);
        }
    }
    
    private void enrichDrinkWithDetails(Drinks drink) {
        // Set image path, color, category, and description based on drink name
        String name = drink.getName().toLowerCase();
        
        if (name.contains("fanta") && name.contains("orange")) {
            drink.setImgSrc("/com/example/demo1/img/fanta_orange.png");
            drink.setColor("FF8C00");
            drink.setCategory("Soft Drinks");
            drink.setDescription("Refreshing orange flavored soda with natural citrus taste");
            addSizesForDrink(drink, new String[]{"300ml", "500ml", "1L"}, 
                            new double[]{50.0, 80.0, 120.0});
        } else if (name.contains("coca") && !name.contains("diet")) {
            drink.setImgSrc("/com/example/demo1/img/coca_cola.png");
            drink.setColor("F40009");
            drink.setCategory("Soft Drinks");
            drink.setDescription("The original cola taste that refreshes");
            addSizesForDrink(drink, new String[]{"300ml", "500ml", "1L"}, 
                            new double[]{55.0, 85.0, 130.0});
        } else if (name.contains("minute")) {
            drink.setImgSrc("/com/example/demo1/img/MinuteMaid.png");
            drink.setColor("FFD700");
            drink.setCategory("Juices");
            drink.setDescription("100% natural fruit juice with vitamins");
            addSizesForDrink(drink, new String[]{"330ml", "500ml", "1L"}, 
                            new double[]{70.0, 100.0, 150.0});
        } else if (name.contains("pepsi")) {
            drink.setImgSrc("/com/example/demo1/img/pepsi.png");
            drink.setColor("004B93");
            drink.setCategory("Soft Drinks");
            drink.setDescription("Bold cola flavor for the young generation");
            addSizesForDrink(drink, new String[]{"300ml", "500ml", "1L"}, 
                            new double[]{50.0, 80.0, 125.0});
        } else if (name.contains("red bull")) {
            drink.setImgSrc("/com/example/demo1/img/red_bull.png");
            drink.setColor("1E90FF");
            drink.setCategory("Energy Drinks");
            drink.setDescription("Wings when you need them most");
            addSizesForDrink(drink, new String[]{"250ml", "350ml"}, 
                            new double[]{150.0, 200.0});
        } else if (name.contains("schweppes")) {
            drink.setImgSrc("/com/example/demo1/img/Schweppes-Tonic-Water.png");
            drink.setColor("008B8B");
            drink.setCategory("Mixers");
            drink.setDescription("Premium tonic water with quinine");
            addSizesForDrink(drink, new String[]{"300ml", "500ml"}, 
                            new double[]{60.0, 90.0});
        } else if (name.contains("coca") && name.contains("diet")) {
            drink.setImgSrc("/com/example/demo1/img/coca_cola_Diet.png");
            drink.setColor("C0C0C0");
            drink.setCategory("Soft Drinks");
            drink.setDescription("Zero calories, same great taste");
            addSizesForDrink(drink, new String[]{"300ml", "500ml", "1L"}, 
                            new double[]{55.0, 85.0, 130.0});
        } else if (name.contains("sprite")) {
            drink.setImgSrc("/com/example/demo1/img/sprite.png");
            drink.setColor("32CD32");
            drink.setCategory("Soft Drinks");
            drink.setDescription("Crisp lemon-lime taste that cuts through");
            addSizesForDrink(drink, new String[]{"300ml", "500ml", "1L"}, 
                            new double[]{50.0, 80.0, 120.0});
        } else if (name.contains("water")) {
            drink.setImgSrc("/com/example/demo1/img/water_bottle.png");
            drink.setColor("87CEEB");
            drink.setCategory("Water");
            drink.setDescription("Pure drinking water for hydration");
            addSizesForDrink(drink, new String[]{"500ml", "1L", "1.5L"}, 
                            new double[]{30.0, 50.0, 70.0});
        } else if (name.contains("7up")) {
            drink.setImgSrc("/com/example/demo1/img/7up.png");
            drink.setColor("00FF7F");
            drink.setCategory("Soft Drinks");
            drink.setDescription("The uncola with natural lemon lime flavor");
            addSizesForDrink(drink, new String[]{"300ml", "500ml", "1L"}, 
                            new double[]{50.0, 80.0, 120.0});
        } else if (name.contains("fanta") && name.contains("pineapple")) {
            drink.setImgSrc("/com/example/demo1/img/Pineapple.png");
            drink.setColor("FFD700");
            drink.setCategory("Soft Drinks");
            drink.setDescription("Tropical pineapple flavor explosion");
            addSizesForDrink(drink, new String[]{"300ml", "500ml", "1L"}, 
                            new double[]{50.0, 80.0, 120.0});
        } else {
            // Default values for any other drinks
            drink.setImgSrc("/com/example/demo1/img/default_drink.png");
            drink.setColor("CCCCCC");
            drink.setCategory("Other");
            drink.setDescription("Refreshing beverage");
            addSizesForDrink(drink, new String[]{"500ml"}, new double[]{drink.getUnitPrice()});
        }
    }
    
    private void addSizesForDrink(Drinks drink, String[] sizes, double[] prices) {
        for (int i = 0; i < sizes.length && i < prices.length; i++) {
            drink.addSize(sizes[i], prices[i]);
        }
    }

    private List<Drinks> getHardcodedDrinks() {
        List<Drinks> drinks = new ArrayList<>();

        // Create drinks with IDs to match database
        Drinks fantaOrange = createDrink("Fanta Orange 500ml", "/com/example/demo1/img/fanta_orange.png",
        ...
        fantaOrange.setDrinkId(9);
        drinks.add(fantaOrange);

        Drinks cocaCola = createDrink("Coca-Cola 500ml", "/com/example/demo1/img/coca_cola.png",
                "F40009", "Soft Drinks", "The original cola taste that refreshes",
                new String[]{"300ml", "500ml", "1L"}, new double[]{55.0, 85.0, 130.0});
        cocaCola.setDrinkId(12);
        drinks.add(cocaCola);

        Drinks minuteMaid = createDrink("Minute Maid 500ml", "/com/example/demo1/img/MinuteMaid.png",
                "FFD700", "Juices", "100% natural fruit juice with vitamins",
                new String[]{"330ml", "500ml", "1L"}, new double[]{70.0, 100.0, 150.0});
        minuteMaid.setDrinkId(15);
        drinks.add(minuteMaid);

        Drinks pepsi = createDrink("Pepsi 500ml", "/com/example/demo1/img/pepsi.png",
                "004B93", "Soft Drinks", "Bold cola flavor for the young generation",
                new String[]{"300ml", "500ml", "1L"}, new double[]{50.0, 80.0, 125.0});
        pepsi.setDrinkId(18);
        drinks.add(pepsi);

        Drinks redBull = createDrink("Red Bull 250ml", "/com/example/demo1/img/red_bull.png",
                "1E90FF", "Energy Drinks", "Wings when you need them most",
                new String[]{"250ml", "350ml"}, new double[]{150.0, 200.0});
        redBull.setDrinkId(21);
        drinks.add(redBull);

        Drinks schweppes = createDrink("Schweppes Tonic 500ml", "/com/example/demo1/img/Schweppes-Tonic-Water.png",
                "008B8B", "Mixers", "Premium tonic water with quinine",
                new String[]{"300ml", "500ml"}, new double[]{60.0, 90.0});
        schweppes.setDrinkId(23);
        drinks.add(schweppes);

        Drinks cocaColaDiet = createDrink("Coca-Cola Diet 500ml", "/com/example/demo1/img/coca_cola_Diet.png",
                "C0C0C0", "Soft Drinks", "Zero calories, same great taste",
                new String[]{"300ml", "500ml", "1L"}, new double[]{55.0, 85.0, 130.0});
        cocaColaDiet.setDrinkId(25);
        drinks.add(cocaColaDiet);

        Drinks sprite = createDrink("Sprite 500ml", "/com/example/demo1/img/sprite.png",
                "32CD32", "Soft Drinks", "Crisp lemon-lime taste that cuts through",
                new String[]{"300ml", "500ml", "1L"}, new double[]{50.0, 80.0, 120.0});
        sprite.setDrinkId(28);
        drinks.add(sprite);

        Drinks water = createDrink("Water 500ml", "/com/example/demo1/img/water_bottle.png",
                "87CEEB", "Water", "Pure drinking water for hydration",
                new String[]{"500ml", "1L", "1.5L"}, new double[]{30.0, 50.0, 70.0});
        water.setDrinkId(31);
        drinks.add(water);

        Drinks sevenUp = createDrink("7UP 500ml", "/com/example/demo1/img/7up.png",
                "00FF7F", "Soft Drinks", "The uncola with natural lemon lime flavor",
                new String[]{"300ml", "500ml", "1L"}, new double[]{50.0, 80.0, 120.0});
        sevenUp.setDrinkId(34);
        drinks.add(sevenUp);

        Drinks fantaPineapple = createDrink("Fanta Pineapple 500ml", "/com/example/demo1/img/Pineapple.png",
                "FFD700", "Soft Drinks", "Tropical pineapple flavor explosion",
                new String[]{"300ml", "500ml", "1L"}, new double[]{50.0, 80.0, 120.0});
        fantaPineapple.setDrinkId(37);
        drinks.add(fantaPineapple);
    ...
    /**
     * Sets the chosen drink and updates the UI
     */
    public void setChosenDrink(Drinks drink) {
